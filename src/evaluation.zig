...
pub const PAWN_VALUE: i32 = 79;
pub const KNIGHT_VALUE: i32 = 320;
pub const BISHOP_VALUE: i32 = 326;
pub const ROOK_VALUE: i32 = 511;
pub const QUEEN_VALUE: i32 = 1029;
...
pub const EvalParams = struct {
    ...
    bishop_value: i32 = 326,
    rook_value: i32 = 511,
    queen_value: i32 = 1029,

    // Scalar evaluation weights
    rook_open_file_bonus: i32 = 20,
    rook_semi_open_file_bonus: i32 = 14,
    rook_on_seventh_bonus: i32 = 25,
    connected_rooks_bonus: i32 = 6,
    isolated_pawn_penalty: i32 = 3,
    backward_pawn_penalty: i32 = 1,
    doubled_pawn_penalty: i32 = 11,
    bishop_pair_bonus: i32 = 30,
    knight_outpost_bonus: i32 = 17,
    bishop_outpost_bonus: i32 = 23,
    tempo_bonus: i32 = 14,
    king_pawn_shield_bonus: i32 = 14,
    king_open_file_penalty: i32 = 17,
    king_center_middlegame_penalty: i32 = 21,
    king_castled_bonus: i32 = 15,
    king_early_walk_penalty: i32 = 18,
    pawn_chain_bonus: i32 = 12,
    protected_passed_pawn_bonus: i32 = 2,
    connected_passed_pawn_bonus: i32 = 24,
    safe_pawn_advance_bonus: i32 = 4,
    mop_up_center_bonus: i32 = 1,
    mop_up_corner_bonus: i32 = 20,
    mop_up_king_proximity_bonus: i32 = 0,
    castling_rights_kingside_bonus: i32 = 49,
    castling_rights_queenside_bonus: i32 = 26,
    pawn_storm_advance_bonus: i32 = 0,
    pawn_storm_near_king_bonus: i32 = 3,
    king_activity_center_bonus: i32 = 2,
    king_activity_mobility_bonus: i32 = 4,
    endgame_phase_threshold: i32 = 163,

    // Piece-Square Tables (index 0 = a1, 63 = h8, white perspective)
    pawn_table: [64]i32 = .{
           0,    0,    0,    0,    0,    0,    0,    0,
          11,    7,    2,  -21,  -32,   15,   14,   -7,
          17,   12,   -1,   -6,   -3,    0,   -3,   -4,
          24,   10,    7,   14,   11,   18,    6,   10,
          25,   26,   -2,    1,    1,    0,   14,    5,
          49,   35,   18,    3,   16,    4,   15,   26,
          79,   76,   49,   41,   34,   60,    1,   45,
           0,    0,    0,    0,    0,    0,    0,    0,
    },
    knight_table: [64]i32 = .{
         -50,  -11,  -23,   -3,  -32,  -18,   -7,  -50,
         -53,  -50,  -12,    9,    1,   -4,   13,  -36,
         -41,  -16,    1,   17,   21,   -4,   22,  -43,
          -8,   14,   11,  -13,   18,   29,  -30,   12,
         -15,    1,   14,   23,   -1,   37,    5,   21,
          -2,   29,   14,   19,   24,   33,   -2,  -33,
         -19,  -26,   14,   27,   15,   10,  -10,  -46,
         -83,  -27,   -5,  -30,  -30,  -30,  -40,  -60,
    },
    bishop_table: [64]i32 = .{
         -20,  -14,  -10,   -2,  -14,  -14,  -17,  -20,
          17,  -19,   -2,   -6,   -4,   -2,    3,  -33,
         -13,   16,   11,   11,    7,   16,    7,  -18,
         -21,   -8,    4,   24,   18,    1,   -1,  -17,
          -3,   -1,    0,   11,    5,    2,  -11,   -1,
           4,   -4,   20,   -3,   11,    9,   30,   -4,
         -18,   25,   -8,  -13,   12,   -5,   -6,  -24,
         -15,  -10,    0,  -27,  -10,  -12,  -10,  -20,
    },
    rook_table: [64]i32 = .{
         -11,   -5,    1,  -10,   -5,   -4,    2,  -19,
         -16,  -13,    4,   -7,  -10,   -6,  -12,  -27,
         -13,  -13,   -9,  -23,  -15,   -6,   -5,  -14,
           5,   -3,   19,    0,   -7,    8,   -5,   18,
           7,    6,   14,   18,   10,   15,    8,   -3,
          27,   33,   23,   20,    7,   24,   24,    0,
           8,   -2,    1,    6,   18,    6,   19,    5,
          25,   31,   21,   17,   -1,   15,   22,   12,
    },
    queen_table: [64]i32 = .{
         -37,  -24,   -4,    0,  -12,  -34,  -30,  -20,
         -28,  -11,    4,   -3,    1,   -5,    2,  -26,
          -5,  -15,    6,   -6,   14,   13,   14,  -37,
         -15,  -23,    3,    6,   17,   18,   19,   13,
         -16,  -11,    6,   20,   32,   18,    9,   18,
           0,   -9,   16,   10,   29,   41,   33,   23,
         -16,  -11,   -2,   21,   17,   13,   27,   17,
         -40,  -25,   14,    8,    4,    0,  -20,    3,
    },
    king_middlegame_table: [64]i32 = .{
          25,   40,   24,   -7,  -16,  -24,   22,   15,
          15,   18,  -10,    7,   -8,   -9,   30,   59,
         -10,  -20,  -15,  -28,    0,  -27,  -35,  -15,
         -20,  -30,  -30,  -40,  -54,  -35,  -30,  -20,
    ...
    king_endgame_table: [64]i32 = .{
         -45,  -43,  -28,  -44,  -28,  -23,  -42,  -60,
         -58,  -22,  -26,  -10,    2,   -5,  -18,  -32,
         -30,   -5,   -5,   19,   18,    6,   -8,  -37,
         -35,   -5,   30,   53,   24,   18,  -16,  -20,
         -25,  -10,   60,   66,   30,   35,   17,  -32,
         -30,   14,   28,   39,   40,   35,   -5,  -30,
